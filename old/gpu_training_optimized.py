...
# %%
def create_gpu_optimized_dataset(num_samples: int = 10000, use_real_data: bool = True, dataset_size: str = "small"):
    """Erstellt GPU-optimierten Datensatz - jetzt mit echten Daten!"""

    if use_real_data:
        print("🎯 Loading REAL FineWeb-Edu Dataset...")
        try:
            # Import dataset loader
            from dataset_loader import create_fineweb_dataloader
            ...
            print("⚠️  dataset_loader not found - falling back to synthetic data")
            use_real_data = False
...
# %%
def memory_optimized_training_loop(use_real_data: bool = True, dataset_size: str = "small"):
    """Memory-Optimized Training mit echten FineWeb-Edu Daten!"""
    ...
    # Dataset - jetzt mit echten Daten!
...
if __name__ == "__main__":
    print("=== GPU-OPTIMIERTE TRAINING MIT FINEWEB-EDU ===")
    ...
    print(f"🎯 Dataset: FineWeb-Edu (High-quality web content)")
    print()

    # Start Training mit echten Daten
    memory_optimized_training_loop(
        use_real_data=True,      # 🎯 Echte Daten verwenden!
        dataset_size="small"     # 10K samples für ersten Test
    )
